...
import com.liangxun.yuejiula.ui.PublishVideoActivity;
 ...
 *
 */
public class VideoPlayerActivityT extends BaseActivity implements
...
//			Intent videoMine = new Intent(VideoPlayerActivityT.this, PublishVideoActivity.class);
//			videoMine.putExtra("path", mPath);
//			startActivity(videoMine);
//			Intent intent= new Intent();
//			intent.putExtra("video_url", mPath);
//			this.setResult(0, intent);
			Intent intent1 = new Intent("add_video_goods_success");
			intent1.putExtra("video_url", mPath);
