 ...
 *
 */
public class MediaPreviewActivityT extends BaseActivity implements
		...
		new AsyncTask<Void, Void, File>() {
			...
			protected File doInBackground(Void... params) {
				...
				File result = ThemeHelper.prepareTheme(
						MediaPreviewActivityT.this, mThemeCacheDir);
				if (result != null) {
					// 主题列表
				...
				// 加载滤镜
				mFilterList = ThemeHelper.parseTheme(MediaPreviewActivityT.this,
	...
	private ThemeView addThemeItem(ThemeGroupLayout layout,
		...
		ThemeView themeView = new ThemeView(MediaPreviewActivityT.this, theme);
	...
	private Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case UtilityAdapter.NOTIFYVALUE_HAVEERROR:
				/** 无法播放时报告 */
				if (!isFinishing()) {
					Toast.makeText(MediaPreviewActivityT.this,
	...
	private void onEncodingEnd() {
		...
		startActivity(new Intent(this, VideoPlayerActivityT.class).putExtra(
				"path", mVideoPath));
		finish();
