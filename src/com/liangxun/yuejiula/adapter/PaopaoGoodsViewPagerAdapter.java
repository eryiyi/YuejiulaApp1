 ...
 */
public class PaopaoGoodsViewPagerAdapter extends PagerAdapter {
    ...
    public PaopaoGoodsViewPagerAdapter(Context cx) {
        mContext = cx;
    }
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        holder.iv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                onClickContentItemListener.onClickContentItem(position, 1, "1001");
            }
        });
        imageLoader.displayImage(mPaths.get(position), holder.iv, UniversityApplication.options,animateFirstListener);
