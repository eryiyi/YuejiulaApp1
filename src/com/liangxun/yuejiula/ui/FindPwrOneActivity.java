        ...
        switch (v.getId()) {
            case R.id.btn_code:
                ...
                if(!TextUtils.isEmpty(mm_emp_mobile.getText().toString()) && mm_emp_mobile.getText().toString().length() == 11){
                    ...
                    showMsg(FindPwrOneActivity.this, res.getString(R.string.pwr_error_seven));
                    return;
                }
                break;
...
//				((Throwable) data).printStackTrace();
                Toast.makeText(FindPwrOneActivity.this, R.string.code_msg_two, Toast.LENGTH_SHORT).show();
